...
class dragon:
    ...
    def __init__(self):
        self.image = load_image('img/dragon.png')
...
class flames:
    ...
    def __init__(self):
        self.image = load_image('img/fireball.png')
        self.imagerect = self.image.get_rect()
...
class maryo:
    ...
    def __init__(self):
        self.image = load_image('img/maryo.png')
        self.imagerect = self.image.get_rect()
